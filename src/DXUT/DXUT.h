...
#include <string>
#include <queue> 
#include <time.h> //[2014.11.18 ]
#include <algorithm> //[2014.12.8 ]
//////////////////////////////////////////////////////////////////////////
//여기서부터 내가만든파일
...
#include "../SHParticle.h" //파티클 시스템 클래스

#include "../SH_Sprite.h" 

#include "../GameSystem.h"

#include "../SHCollision.h"//충돌전용
...
#include "../ASEData.h" //ase data

#include "../Object.h"



#include "../SHBillBoard.h"//빌보드클래스
...
//////////////////////////////////////////////////////////////////////////
#include "atlstr.h"  // CString 때문에 선언
#include "strsafe.h"//가장 나중에 선언해줄것
